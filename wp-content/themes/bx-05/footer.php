...
<div class="c-float-bottom">
  <div class="o-center">
    <div class="o-cluster o-cluster--middle o-cluster--center">
      <div class="o-stack">
...
<?php endif;?>
<footer class="o-center c-footer u-bg-primary">
  <div class="o-stack u-max-item u-block-center u-mb-m">
    <ul class="o-cluster o-cluster--gap-s u-mb-m">
      <li class="c-ft-item u-text-center"><a class="c-ft-link c-content-m u-font-en-con"
          href="<?php echo home_url('/company/');?>">COMPANY</a>
      </li>
      <li class="c-ft-item u-text-center"><a class="c-ft-link c-content-m u-flex-shrink-none u-font-en-con"
    ...
    <a href="#" class="o-icon-parent o-icon-parent--center o-icon-parent--text-center o-icon-parent--gap-s c-logo-link">
