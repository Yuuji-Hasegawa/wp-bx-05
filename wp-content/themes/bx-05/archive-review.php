...
<div class="c-puton c-puton--filter">
  ...
  <div class="c-puton__inner o-cover">
    <h1 class="c-hero-copy o-cover__middle">
      <span class="c-display-l u-text-weight-b u-font-en-con">Review</span>
      <span class="c-display-xs">お客様の声</span>
    </h1>
  </div>
</div>
<div class="o-box o-box--transparent o-center u-bg-qua u-pb-2xl">
  <h2 class="c-sec-heading u-text-center u-text-weight-b">現在の口コミ状況</h2>
  ...
  <?php if (have_posts()):?>
  <ul class="o-stack o-stack--l u-mb-xl">
    <?php while (have_posts()): the_post();
        $rating = intval(get_post_meta(get_the_ID(), 'review_rate', true));?>
    <li class="o-stack o-stack--s u-bg-secondary u-pt-m u-pb-m u-pr-m u-pl-m">
      <span class="o-cluster o-cluster--middle o-cluster--gap-s">
        <span class="c-reviewer-pict">
          <?php echo get_reviewer_pict();?>
        </span>
        <span
          class="u-text-weight-b c-content-m"><?php the_title();?></span>
        <time class="u-font-en-con u-text-weight-m c-suppl-l"
          datetime="<?php the_time('Y-m-d');?>"><?php the_time('Y.m.d');?></time>
      </span>
      <span class="o-cluster o-cluster--middle c-review-stars"
      ...
      <p class="c-content-l u-text-trim u-text-trim--three-line">
        <?php the_content();?>
      </p>
    </li>
    <?php endwhile;?>
  ...
  <?php else:?>
  <p class="c-content-l">お客様の声はまだありません。</p>
  <?php endif;
echo get_pagination();?>
</div>
<?php get_footer();?>
